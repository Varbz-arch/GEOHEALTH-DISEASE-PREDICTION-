...
st.title("🌍 GeoHealth Disease Prediction App")
st.write("Enter environmental and health parameters to predict disease risk.")

# INPUT FIELDS (adjust based on your dataset)
temp_max = st.number_input("Temperature Max (°C)")
temp_min = st.number_input("Temperature Min (°C)")
...
if st.button("Predict"):
    ...
    input_data = np.array([[temp_max, temp_min, humidity, rainfall, wind_speed, aqi]])
